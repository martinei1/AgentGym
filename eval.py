...
def main():
    ...
    args['output_file'] = '{}/{}/{}'.format(args['output_file'],args['model_path'],args['task_name'])
    print(args['output_file'])
    os.makedirs(args['output_file'],exist_ok=True)
    args['output_file'] = '{}/log'.format(args['output_file'])
    ...
    data_idxs = [[int(item["item_id"])] for item in test_data] #[[int(item["item_id"].split("_")[-1])] for item in test_data]
